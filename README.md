...
[![LWC line coverage: 98.48%](https://img.shields.io/badge/LWC_lines-98.48%25-brightgreen)](./config/quality-metrics.json)
...
| Apex                  | 321 classes, including 146 `@IsTest` classes and 2 global contract-test support classes · [size breakdown](./docs/architecture/apex-implementation/README.md#codebase-size-and-verification) · 97.17% coverage from the complete namespaced 2.0.10 source test run · Salesforce-validated 2.0.9.2 package coverage: 99% |
| LWC                   | 2 Lightning Web Components · 335 Jest tests · 98.48% line coverage · 91.40% branch coverage                                                                                                                                                                                                                             |
...
| Documentation         | 147 maintained pages, including 18 documented Check examples                                                                                                                                                                                                                                                            |
