...
| Apex                  | 243 classes, including 126 `@IsTest` classes and 1 global contract-test support class · [size breakdown](./docs/architecture/apex-implementation/README.md#codebase-size-and-verification) · 99.64% namespaced package coverage · 99.57% subscriber-style coverage |
...
| Documentation         | 142 maintained pages, including 19 documented Check examples                                                                                                                                                                                                       |
