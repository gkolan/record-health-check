...
| Apex                  | 350 classes, including 164 `@IsTest` classes and 2 global contract-test support classes · [size breakdown](./docs/architecture/apex-implementation/README.md#codebase-size-and-verification) · 97.86% coverage from the complete namespaced 2.0.10 source test run · Salesforce-validated 2.0.9.2 package coverage: 99% |
...
| Documentation         | 156 maintained pages, including 18 documented Check examples                                                                                                                                                                                                                                                            |
