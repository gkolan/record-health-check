...
| Display Found text          | DisplayFoundText\_\_c           | N/A                                                                                                                                                                                                                              | FORMULA type Checks use DisplayFoundFormula\_\_c instead.                         |
| Display Expected text       | DisplayExpectedText\_\_c        | N/A                                                                                                                                                                                                                              | FORMULA type Checks use DisplayExpectedFormula\_\_c instead.                      |
...
| Source query                | SourceQuery\_\_c                | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Source query field          | SourceQueryField\_\_c           | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Comparison query            | ComparisonQuery\_\_c            | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Comparison query field      | ComparisonQueryField\_\_c       | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Query result handling       | QueryResultHandling\_\_c        | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Comparison operator         | ComparisonOperator\_\_c         | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Expected value source       | ExpectedValueSource\_\_c        | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Expected fixed value        | ExpectedFixedValue\_\_c         | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Expected record formula     | ExpectedRecordFormula\_\_c      | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Expected currency code      | ExpectedCurrencyIsoCode\_\_c    | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Find in list formula        | FindInListFormula\_\_c          | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| No rows result              | NoRowsResult\_\_c               | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Empty value handling        | EmptyValueHandling\_\_c         | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Max query rows              | MaxQueryRows\_\_c               | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run queries.                                 |
| Apex class                  | ApexClass\_\_c                  | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run Apex.                                    |
| Apex parameters (JSON)      | ApexParametersJson\_\_c         | N/A                                                                                                                                                                                                                              | Not used; FORMULA type Checks do not run Apex.                                    |
