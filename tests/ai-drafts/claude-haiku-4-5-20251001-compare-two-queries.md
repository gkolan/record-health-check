...
| No Rows Result                | NoRowsResult\_\_c                | N/A                                                                                                                                                    | Not used; ONE_RESULT aggregate comparisons are always one row                          |
...
| Display Found Formula         | DisplayFoundFormula\_\_c         | N/A                                                                                                                                                    | Not used; this is COMPARE_TWO_QUERIES, not FORMULA                                     |
| Display Expected Formula      | DisplayExpectedFormula\_\_c      | N/A                                                                                                                                                    | Not used; this is COMPARE_TWO_QUERIES, not FORMULA                                     |
| Pass Condition Formula        | PassConditionFormula\_\_c        | N/A                                                                                                                                                    | Not used; comparison operator defines pass condition for COMPARE_TWO_QUERIES           |
| Formula Result Type           | FormulaResultType\_\_c           | N/A                                                                                                                                                    | Not used; this is COMPARE_TWO_QUERIES, not FORMULA                                     |
| Find In List Formula          | FindInListFormula\_\_c           | N/A                                                                                                                                                    | Not used; this is COMPARE_TWO_QUERIES, not FORMULA                                     |
| Apex Class                    | ApexClass\_\_c                   | N/A                                                                                                                                                    | Not used; this is COMPARE_TWO_QUERIES, not APEX                                        |
| Apex Parameters JSON          | ApexParametersJson\_\_c          | N/A                                                                                                                                                    | Not used; this is COMPARE_TWO_QUERIES, not APEX                                        |
| Expected Value Source         | ExpectedValueSource\_\_c         | N/A                                                                                                                                                    | Not used; the Comparison Query is the expected side                                    |
| Expected Fixed Value          | ExpectedFixedValue\_\_c          | N/A                                                                                                                                                    | Not used; the Comparison Query is the expected side                                    |
| Expected Record Formula       | ExpectedRecordFormula\_\_c       | N/A                                                                                                                                                    | Not used; the Comparison Query is the expected side                                    |
| Expected Currency ISO Code    | ExpectedCurrencyIsoCode\_\_c     | N/A                                                                                                                                                    | Not used; the Comparison Query is the expected side                                    |
