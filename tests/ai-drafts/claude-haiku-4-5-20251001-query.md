...
| Run Button Label           | RunButtonLabel\_\_c       | N/A                                                    | Button is hidden; this field is not used.                          |
| Rerun Button Label         | RerunButtonLabel\_\_c     | N/A                                                    | Button is hidden; this field is not used.                          |
| Run Button Icon            | RunButtonIcon\_\_c        | N/A                                                    | Button is hidden; this field is not used.                          |
...
| If Query Finds No Records     | NoRowsResult\_\_c                | N/A                                                                                                                                                                           | A bare COUNT() query always returns exactly one aggregate row, even when the count is zero; this field never applies. Use ApplicabilityMode = WHEN_COUNT_QUERY_MATCHES instead to skip when no open Opportunities exist. |
...
| Pass Condition Formula        | PassConditionFormula\_\_c        | N/A                                                                                                                                                                           | QUERY Evaluation Type does not use Salesforce formulas for pass/fail logic.                                                                                                                                              |
| Formula Result Type           | FormulaResultType\_\_c           | N/A                                                                                                                                                                           | QUERY Evaluation Type does not use Salesforce formulas for pass/fail logic.                                                                                                                                              |
| Display Found Formula         | DisplayFoundFormula\_\_c         | N/A                                                                                                                                                                           | QUERY Evaluation Type does not use formula display; use DisplayFoundText\_\_c instead.                                                                                                                                   |
| Display Expected Formula      | DisplayExpectedFormula\_\_c      | N/A                                                                                                                                                                           | QUERY Evaluation Type does not use formula display; use DisplayExpectedText\_\_c instead.                                                                                                                                |
| Apex Class                    | ApexClass\_\_c                   | N/A                                                                                                                                                                           | QUERY Evaluation Type does not use Apex.                                                                                                                                                                                 |
| Apex Parameters JSON          | ApexParametersJson\_\_c          | N/A                                                                                                                                                                           | QUERY Evaluation Type does not use Apex.                                                                                                                                                                                 |
