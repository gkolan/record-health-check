...
lifecycle-event, administrator, diagnostic-detail, or restricted error-log access unless the
separate optional publisher Permission Set is deliberately assigned.
