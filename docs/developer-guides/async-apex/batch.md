...
event](../../save-results/save-run-summaries.md) or [Subscribe to the Check Result
event](../../save-results/save-individual-results.md) to enable publication and build the receiving Flow or
Apex trigger.
...
5. If a group of records fails with an exception, review the
   [`BATCH_SCOPE_FAILED` error event](../../save-results/save-restricted-errors.md).
