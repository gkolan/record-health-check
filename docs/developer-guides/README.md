...
If you use only the Lightning card, start with [Choose how a Check starts](../start-here/choose-how-checks-run.md)
...
- [Integration overview](./integration-options.md)
