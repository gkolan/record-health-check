...
[Queueable Apex](./async-apex/queueable.md) when the work can happen later and fits in one request. Use
[Batch Apex](./async-apex/batch.md) when the records need several transactions.
...
[Apex Check contract](./write-an-apex-check.md). Background-job entry
points are documented in [Queueable](./async-apex/queueable.md), [Batch](./async-apex/batch.md), and
[Scheduled](./async-apex/scheduled.md).
...
- [Apex plugin contract](./write-an-apex-check.md)
- [Apex class catalog](../architecture/apex-implementation/README.md)
- [Flow API](../flow-guides/run-a-check.md)
- [Upgrade guide](../install/upgrade.md)
