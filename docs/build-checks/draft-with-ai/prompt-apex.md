...
Use this prompt only when Formula and Query settings cannot express the requirement safely. Confirm
the draft against the [Apex Check contract](../../developer-guides/write-an-apex-check.md) and
[Apex examples](../../examples/apex/README.md).
...
- Mark N/A: PassConditionFormula__c, FormulaResultType__c, SourceQuery__c, SourceQueryField__c,
