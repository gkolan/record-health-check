...
See [Lifecycle events: missing or repeated events](../save-results/when-to-use-platform-events.md#when-an-event-is-missing-or-processed-twice)
for symptom-to-cause mapping, and
[Platform Event receiving automation checklist](../save-results/README.md#receiving-automation-checklist)
...
[Upgrade and revalidate: Revalidate what people use](../install/upgrade.md#step-3-revalidate-what-people-use).
