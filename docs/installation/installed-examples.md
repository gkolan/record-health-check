...
- Install Record Health Check and assign **Record Health Check User** to the person testing it.
...
Check Set and that the user has **Record Health Check User**. For an Unable to Check or System Error
result, follow [Troubleshoot with Show Diagnostics](../guides/troubleshoot-with-show-diagnostics.md).
...
- [Create your first Check](create-your-first-check.md)
