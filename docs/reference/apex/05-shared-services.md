...
- **Example:** `formatList` limits the rendered preview to `LIST_PREVIEW_CAP` (`10`) entries and
 ...
 contract: [Reference: Display value format](../contracts/03-display-value-format.md).
...
- Full contract: [Reference: Display value format](../contracts/03-display-value-format.md).
...
**See also:** [Log event metadata](../../metadata/05-event-log.md)
