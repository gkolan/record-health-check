...
Use the [Record Health Check Result event](./check-result.md) instead when the receiving Flow,
...
returned directly by the [Flow action](../../flow-guides/action-inputs-and-outputs.md) or
[Apex API](../../developer-guides/run-from-apex.md). A Platform Event is delivered separately after publication.
...
[Save Check Set run summaries](../../save-results/save-run-summaries.md).

## Related

- [Save Check Set run summaries with Flow or Apex](../../save-results/save-run-summaries.md)
- [Choose whether to publish result events](../../save-results/when-to-use-platform-events.md)
- [Record Health Check Result Platform Event](./check-result.md)
- [Record Health Check Log Platform Event](./error-log.md)
