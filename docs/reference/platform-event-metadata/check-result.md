...
> [!TIP]
> **Event navigation:** [Publication behavior](../../save-results/when-to-use-platform-events.md) ·
> [Build Check Result receiving automation](../../save-results/save-individual-results.md) ·
...
Use the [lifecycle-events overview](../../save-results/when-to-use-platform-events.md) for publication sources,
...
- [Subscribe with Flow or Apex](../../save-results/save-individual-results.md)
- [Lifecycle-events overview](../../save-results/when-to-use-platform-events.md)
- [Check Set Run Platform Event](./check-set-run.md)
- [Log Platform Event](./error-log.md)
- [Check fields](../custom-metadata/check-fields.md): **Publish User Result Event**
