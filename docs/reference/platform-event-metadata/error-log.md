...
[Save or route Record Health Check errors](../../save-results/save-restricted-errors.md).
...
[Check Set fields](../custom-metadata/check-set-fields.md) for the distinction.
...
- [Record Health Check Set Run Platform Event](./check-set-run.md)
