# Result statuses and card labels
...
4. Follow [Troubleshoot Record Health Check](../../diagnostics/browser-console.md).

## Related

- [How a Check can start](../../start-here/choose-how-checks-run.md)
- [Where results can go](../../start-here/choose-where-results-go.md)
