...
Check this page before installation or when an org feature differs from an example.
...
Do not plan an installation in Professional, Group, or Essentials edition. This project does not
support or test that combination of package, Apex, API, Platform Event, and Lightning capabilities.
...
[Display value format: Currency](../configuration/display-found-and-expected.md#currency).
...
See [Platform limitations and safe patterns](./limitations.md#person-accounts) for the
...
[Agent tool REST API](../../developer-guides/agentforce-and-mcp/agent-tool-rest-api.md) and
[Architecture: Out of scope](../../architecture/framework.md#16-out-of-scope).
