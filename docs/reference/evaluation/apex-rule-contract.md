...
side effect. Catch record-specific evaluation failures inside the record loop and return
...
test. The harness measures scopes of 1, 10, 50, and 200 records.

Permission behavior needs a controlled least-privilege fixture. Apex exposes no runtime
...
authors should compile and run the contract harness against the package release they plan to
