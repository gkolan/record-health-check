...
| --- | --- | --- | --- |
| Check Set | Picklist | Restricted value set | [`CardHeadingDisplay__c`](../custom-metadata/check-set-fields.md#card-heading-display-cardheadingdisplay__c), [`CardRevealMode__c`](../custom-metadata/check-set-fields.md#reveal-mode-cardrevealmode__c), [`CardRunMode__c`](../custom-metadata/check-set-fields.md#when-checks-run-cardrunmode__c), [`FoundExpectedDisplay__c`](../custom-metadata/check-set-fields.md#foundexpected-display-foundexpecteddisplay__c), [`PassedChecksDisplay__c`](../custom-metadata/check-set-fields.md#passed-checks-passedchecksdisplay__c), [`RunButtonDisplay__c`](../custom-metadata/check-set-fields.md#run-button-display-runbuttondisplay__c), [`SkippedChecksDisplay__c`](../custom-metadata/check-set-fields.md#skipped-checks-skippedchecksdisplay__c), [`SummaryDisplay__c`](../custom-metadata/check-set-fields.md#summary-display-summarydisplay__c) |
...
This page covers all **19 Check Set fields** and **45 Check fields** in the shipped Custom Metadata definitions.
