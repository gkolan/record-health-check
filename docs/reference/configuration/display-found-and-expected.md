...
> - Merge-token substitution uses a different path; see [Merge tokens](../merge-syntax/README.md).
...
- Date/Datetime chips use display locale and timezone rules; they do not prove that a Formula Pass
  Condition used the same day boundary. See [timezone-safe patterns](../platform/limitations.md#currency-dates-and-display).
...
- [Reference: Apex classes](../../architecture/apex-implementation/shared-services.md#recordhealthcheckdisplayformat):
...
- [Apex Check contract](../../developer-guides/write-an-apex-check.md): Found and Expected values returned by a custom Apex Check
