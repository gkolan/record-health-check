...
> - For the field definitions, use the [Check fields reference](../metadata/fields-check.md).
...
- [**Fix Message** (`FixMessage__c`)](../metadata/fields-check.md#fix-message-fixmessage__c)
...
- [Check fields](../metadata/fields-check.md): field definitions for `ActionLabel__c`, `ActionUrl__c`, and `FixMessage__c`
- [Field limits](../reference/contracts/field-limits.md): character limits for these fields
- [Troubleshoot Record Health Check](troubleshoot-with-show-diagnostics.md): troubleshooting a Check that fails to evaluate
