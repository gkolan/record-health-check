# Draft Record Health Check configuration with AI
...
Confirm every value against [Check Set fields](../metadata/fields-check-set.md). The labels are what
...
Confirm every value against [Check fields](../metadata/fields-check.md) and a matching page in the
...
See the [Apex Check contract](../reference/evaluation/apex-check-contract.md) before approving code.
