...
[complete field reference](../metadata/event-check-result.md).
...
access to this Platform Event. Separately give the Flow or Apex code the access required for the
destination object and any follow-up records.
...
- [Record Health Check Result event fields](../metadata/event-check-result.md)
