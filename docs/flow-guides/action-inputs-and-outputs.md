...
[Run Record Health Check from Flow](./run-a-check.md). Use this page as the complete input/output and
...
Use the [reason-code reference](../reference/results/reason-codes.md) when the action returns a code you do
not recognize.
...
guidance, see [Lifecycle events](../save-results/when-to-use-platform-events.md).
