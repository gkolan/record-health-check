# Save or send results after a run
...
For the exact fields, see the [Platform Event metadata reference](../reference/platform-event-metadata/README.md).
...
See [Save Check Set run summaries](./save-run-summaries.md) for the complete field mapping and Apex option.
...
Check Admin** Permission Sets include access to the Set Run and Check Result events. They do not
include access to the restricted Log event.
...
- [Record Health Check Platform Event fields](../reference/platform-event-metadata/README.md)
- [Save Check Set run summaries](./save-run-summaries.md)
- [Save or route individual Check results](./save-individual-results.md)
- [Save or route restricted errors](./save-restricted-errors.md)
- [Receive events with Pub/Sub API](../developer-guides/receive-events-with-pub-sub.md)
