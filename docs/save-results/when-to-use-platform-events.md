...
> [Build receiving automation](./README.md) ·
> [Subscribe externally](../developer-guides/receive-events-with-pub-sub.md) ·
> [Look up event fields](../reference/platform-event-metadata/README.md)
...
5. Assign event object access to the receiving Flow user, Apex context, or integration. The packaged
   Card User, User, and Admin Permission Sets include Set Run and Check Result access, but not the
...
For the end-to-end model, start with [Integrate Record Health Check](../developer-guides/integration-options.md).
...
1. Assign the receiving user access to the selected Platform Event and choose Flow, Apex, or Pub/Sub
   ...
   field visibility in receiving tools. The Card User, User, and Admin Permission Sets grant
   create/read on Set Run and Check Result events. They do **not** grant
   `Record_Health_Check_Log__e`; grant Log object access separately to the users or integration that
...
Event reference](../reference/platform-event-metadata/error-log.md).

## Related

- [Platform Event receiving-process guides](./README.md)
- [External Pub/Sub API integration](../developer-guides/receive-events-with-pub-sub.md)
...
- [Check Set fields](../reference/custom-metadata/check-set-fields.md): Publish User Run Event and Publish Error Log Event
- [Check fields](../reference/custom-metadata/check-fields.md): Publish User Result Event
- [Check Set Run Platform Event](../reference/platform-event-metadata/check-set-run.md)
- [Check Result Platform Event](../reference/platform-event-metadata/check-result.md)
- [Log Platform Event](../reference/platform-event-metadata/error-log.md)
- [Revalidate an installation](../install/upgrade.md)
