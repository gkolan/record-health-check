...
New to the model? Read [Integrate Record Health Check](../developer-guides/integration-options.md) first.
...
[Check Set Run event fields](../reference/platform-event-metadata/check-set-run.md#fields)
...
[Check Result event fields](../reference/platform-event-metadata/check-result.md#fields)
for the complete field list.
...
Use the [lifecycle-events overview](../save-results/when-to-use-platform-events.md) for cross-event behavior and
...
- [Platform events](../save-results/when-to-use-platform-events.md)
