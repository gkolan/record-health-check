...
3. Back up Check Sets and Checks created by your team by following
   [Back up configuration](../production-operations/back-up-configuration.md).
...
Follow [Revalidate or upgrade](../install/upgrade.md) for the complete administrator
...
- [Revalidate or upgrade](../install/upgrade.md)
