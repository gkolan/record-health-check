...
| Result values that automation can use | The save succeeds or shows the configured error | The save continues, shows a warning, or is blocked | Whatever outcomes the Flow was designed to provide | PASS, FAIL, SKIPPED, UNABLE_TO_EVALUATE, or ERROR, with a Reason Code. See [Reason Codes](../reference/results/reason-codes.md) |
...
- [Architecture: Position in the platform](../architecture/framework.md#1-position-in-the-platform)
- [How Record Health Check works](./what-it-does.md)
- [Reason Codes](../reference/results/reason-codes.md)
- [Using Record Health Check FAQ](../faqs/using-record-health-check.md)
