...
For the purpose of every field, see [Check Set fields](../reference/custom-metadata/check-set-fields.md) and
...
[Reason Codes: Applicability and prerequisites](../reference/results/reason-codes.md#applicability-and-prerequisites).
...
setting. See [Lifecycle events](../save-results/when-to-use-platform-events.md) before creating a receiver.
...
- [Platform Event receivers](../save-results/README.md)
- [Where results go](../start-here/choose-where-results-go.md)
