...
**See also:** [Reference: Formula](../../reference/evaluation/formula.md)
...
**See also:** [Reference: Query](../../reference/evaluation/query.md)
...
**See also:** [Reference: Compare two queries](../../reference/evaluation/compare-two-queries.md)
