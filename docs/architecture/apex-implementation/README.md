...
|    9 | Subscriber contract foundations                  | [Subscriber foundations](./subscriber-foundations.md)                                     |
|   10 | Plugin verification test                         | [Plugin verification](../../developer-guides/verify-an-apex-check.md)                     |
|   11 | Test-only access / architecture policy           | [Contributor policy: Apex test-only access](../../quality-gates/apex-test-only-access.md) |
...
| L5    | `RecordHealthCheckBatch`                                                                               | Splits 1–2,000 explicit IDs into automatic formula-safe scopes of 1–100 records, or an explicit scope of 1–200; all share the Batch job Run ID |
...
| L4    | [`RecordHealthCheckScopeDisplayFinalizer`](./scope-orchestration.md#recordhealthcheckscopedisplayfinalizer)     | Resolves display text, diagnostics and evidence using the authorized scope map                    |
...
| L3    | `RecordHealthCheckSoqlValueResolver`                                                                   | Resolves primary and comparison inputs while preserving early empty results |
