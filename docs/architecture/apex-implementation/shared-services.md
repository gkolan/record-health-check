...
- **Example:** `formatList` limits the rendered preview to `LIST_PREVIEW_CAP` (`10`) entries and
 ...
 contract: [Reference: Display value format](../../reference/configuration/display-found-and-expected.md).
...
- Full contract: [Reference: Display value format](../../reference/configuration/display-found-and-expected.md).
...
**See also:** [Log event metadata](../../reference/platform-event-metadata/error-log.md)
