...
Use the [reason-code reference](../reference/contracts/01-reason-codes.md) when the action returns a code you do
not recognize.
...
guidance, see [Lifecycle events](03-lifecycle-events.md).
...
- [Lifecycle events](03-lifecycle-events.md)
