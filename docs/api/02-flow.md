...
| Goal | Start here |
| --- | --- |
| Configure the Action, Decision statuses, collections, and tests | [Flow actions](../integration/02-flow-actions.md) (complete how-to) |
| Compare Flow with Apex, Lightning, and events | [Integration overview](../integration/README.md) |
| Call `evaluate` from Apex instead | [Apex API](01-apex-api.md) |
| Run checks asynchronously | [Queueable](03-queueable.md), [Batch](04-batch.md), or [Scheduled](05-scheduled.md) |
