...
> [!NOTE]
> On this page, move an existing Record Health Check future-method caller to Queueable Apex and
> verify the replacement before removing the future entry point.
...
1. Implement the [Queueable Apex pattern](queueable.md), including its Finalizer.
