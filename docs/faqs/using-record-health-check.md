...
sandbox. See [Compatibility](../reference/platform/compatibility.md).
...
[Read results](../reference/results/statuses-and-labels.md).
...
releases change. See [Operate in production](../production-operations/operate-in-production.md).
...
responsibilities. See [Security and data access](../architecture/security-and-data-access.md).
...
change process explicitly. See [Choose where results go](../start-here/choose-where-results-go.md).
...
Checks and integrations your organization relies on. See [Upgrading](../install/upgrade.md).
...
formally verified. See [Compatibility](../reference/platform/compatibility.md).
...
[Confirm theme, keyboard, and responsive behavior](../lightning-record-page/theme-and-accessibility.md).
...
languages. See [Languages, locale, and translated text](../reference/platform/languages-and-locales.md).
...
Start with [Troubleshooting](../diagnostics/browser-console.md) for an unexpected result and
