...
| --- | --- | --- |
| **Developer Name** | [`DeveloperName`](../../metadata/fields-check.md#developer-name-developername) | `Contact_Email_Excludes_Placeholder_Domain` |
| **Label** | [`MasterLabel`](../../metadata/fields-check.md#label-masterlabel) | Contact Email Excludes Placeholder Domain |
...
| **Expected Value (Fixed)** | [`ExpectedFixedValue__c`](../../metadata/fields-check.md#expected-value-fixed-expectedfixedvalue__c) | `@example.com` (**Replace with your confirmed placeholder or test domain**) |
...
| **Prerequisite Check** | [`PrerequisiteCheck__c`](../../metadata/fields-check.md#prerequisite-check-prerequisitecheck__c) | `Example_Has_At_Least_One_Contact` from [Customer handoff](customer-contact.md) |
...
`Example_Has_At_Least_One_Contact` a lower **Evaluation Order** so it runs first. Comparison Query, list,
