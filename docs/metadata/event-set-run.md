...
> [!NOTE]
> On this page, look up the Check Set Run event fields, publication conditions, security boundary,
> and subscriber responsibilities for one completed Check Set run.

> [!TIP]
> **Event navigation:** [Publication behavior](../integration/lifecycle-events.md) ·
> [Build a Check Set Run subscriber](../platform-events/check-set-run.md) ·
> **Look up Check Set Run fields**
...
[Apex API](../api/apex-api.md) or [Flow action](../integration/flow-actions.md)
response instead.
...
- [Subscribe with Flow or Apex](../platform-events/check-set-run.md)
